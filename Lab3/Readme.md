...
We sketched three potential robots: a trash can robot, a dining table robot, and a food delivery robot. 
![Robot Sketches](https://github.com/celine-lee/Mobile_HRI_Lab_Hub/blob/main/Lab3/robot_drawings.pdf?raw=true)
