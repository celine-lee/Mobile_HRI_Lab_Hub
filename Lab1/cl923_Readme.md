...
- The setting of our interaction is an office kitchen. 
- The players involved are two co-workers and the clonebot.
- The two co-workers are just chatting casually, sipping on coffee and recounting the activities of their respective weekends. They have no intentions but to relax a bit.
- Clonebot is just wandering about. It is shy and does not want to be noticed. It wanders into the office kitchen and happens to bump into the leg of one of the co-workers. Once it realizes that it was noticed, it immediately shuffles backwards from the leg and ducks itself under the cone.
...
We realized that making the interaction more about the human response to CloneBot made more of a difference. So we added the running away from the robot in one of our storyboard act-outs. 
