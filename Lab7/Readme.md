...
We had major obstacles with using the tall table for waiterbot, so after a number of failed sessions of getting waiterbot stable, level, and running, we pivoted designs to: PicnicBot
